...
This document describes how to copy and customise the Lernstar (bootstrap) theme so that
...
From your Moodle theme directory right click on lernstar and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of lernstar.
...
underscores. For the purpose of this tutorial we will call the theme 'lernstar2'.

On opening 'lernstar2' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case lernstar. So using the above list as
a guide, search through and change all the instances of the theme name
'lernstar' to 'lernstar2'. This includes the filename of the lang/en/theme_lernstar.php.
You need to change this to 'theme_lernstar2.php'.
...
and then click on (Lernstar2) or whatever you renamed the theme to,
...
Administration > Site Administration > Appearance > Themes > Lernstar
